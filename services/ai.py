...
def call_gemini_for_module(
    ...
    * The student's message.
    ...
    if CLIENT is None:
        return (
            "Gemini API key is missing. Please set 'GEMINI_API_KEY' in your "
            "Streamlit secrets to enable AI coaching."
        )
    ...
    try:
        ...
        # If anything goes wrong, return a safe message instead of raising
        # an exception that could leak details.
