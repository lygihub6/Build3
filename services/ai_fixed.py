...
IMPORTANT: This version uses gemini-1.5-flash (stable) instead of
experimental models, and implements stricter rate limiting to avoid
quota issues.
"""
...
def call_gemini_for_module(
    ...
    * The student's message.
    ...
    try:
        # Using stable gemini-1.5-flash model instead of experimental version
        # This model has better quota limits and is more reliable
        ...
        # Handle quota/rate limit errors with detailed helpful messages
        if "429" in error_str or "RESOURCE_EXHAUSTED" in error_str or "quota" in error_str.lower():
            return (
                ...
                "**3️⃣ Enable billing** (recommended for regular use)\n"
                "- Go to https://ai.google.dev/pricing\n"
                "- Enable billing for much higher limits:\n"
                "  • 1,000 requests/minute (vs 15 free)\n"
                "  • 4M tokens/minute (vs 1M free)\n"
                "- Cost: ~$0.075 per 1M input tokens\n\n"
                "**4️⃣ Use different model**\n"
                "- Current: gemini-1.5-flash (stable)\n"
                "- Some models have higher free limits\n\n"
                "**Note:** If you just changed API keys, the error might be cached. "
                "Click '🔄 Clear Cache' in the troubleshooting section and try again."
            )
        ...
        # Handle rate limit errors
            ...
            return (
                ...
                "- The app now enforces 10 second delays between requests\n\n"
                "**Why this happens:**\n"
                "Free tier allows 15 requests/minute. If you make requests too fast, "
                "you'll hit this limit even without exceeding daily quota.\n\n"
        ...
        # Handle authentication errors
            ...
            return (
                ...
                "**Check:**\n"
                "1. Is GEMINI_API_KEY set in Streamlit secrets?\n"
                "2. Is the key copied correctly (no extra spaces)?\n"
                "3. Is the key still active at https://aistudio.google.com/apikey?\n\n"
                "**Fix:**\n"
        ...
        # Generic error for everything else
            ...
            return (
                ...
                f"If the problem persists, check your API key settings at "
